...
*   **⚙️ API Ventas (Backend):** Servicio construido en Java Spring Boot, encargado de procesar la lógica de negocio de ventas y transacciones.
*   **📦 API Despachos (Backend):** Servicio construido en Java Spring Boot, dedicado a la gestión logística y despachos.
*   **🗄️ Base de Datos:** MySQL 8.0, aislada en la red interna para máxima seguridad.
